...
public class ColisionRegionCritica implements Runnable {
    private int numero;
    private int other;
    private ExampleType type;
    private float dineroPorRetirar;

    public ColisionRegionCritica(int numero, int other, ExampleType type) {
        this.numero = numero;
        this.other = other;
        this.type = type;
    }

    public ColisionRegionCritica(int numero, int other, ExampleType type, float dineroPorRetirar) {
        this.numero = numero;
        this.other = other;
        this.type = type;
